...
class Video(models.Model):
    ...
    video_720p = models.FileField(upload_to='videos/720p/', null=True, blank=True, max_length=255)
    video_1080p = models.FileField(upload_to='videos/1080p/', null=True, blank=True, max_length=255)
...
class VideoProgress(models.Model):
    ...
    class Meta:
        unique_together = ('user', 'video')  # Verhindert doppelte Einträge
